...
public class Base {
	...
	public void invokeBrowser() {
		...
		System.setProperty("webdriver.chrome.driver", "C:\\Hackathon\\Team7_DisplayBookshelves\\drivers\\chromedriver.exe");
		if (prop.getProperty("browserName").matches("chrome")) {
			driver = new ChromeDriver();
		}

		// To Open Edge Browser
		System.setProperty("webdriver.edge.driver", "C:\\Hackathon\\Team7_DisplayBookshelves\\drivers\\msedgedriver.exe");
		if (prop.getProperty("browserName").matches("edge")) {
			driver = new EdgeDriver();
		}
		
		/*System.setProperty("webdriver.gecko.driver", "C:\\Hackathon\\DisplayBookshelves\\Display Bookshelves\\drivers\\geckodriver.exe");
